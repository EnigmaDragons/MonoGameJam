...
namespace ZeroFootPrintSociety.Credits
{
    ...
    public sealed class LeadArtistCredit : BasicJamCreditSegment
    {
        ...
        public override string Name => "Federico Bellucci";
    }
    ...
    public sealed class LevelDesignerCredit : BasicJamCreditSegment
    {
