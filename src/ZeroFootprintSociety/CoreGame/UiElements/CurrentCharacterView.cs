...
namespace ZeroFootPrintSociety.CoreGame.UiElements
{
    class CurrentCharacterView : IVisualAutomaton
    {
        ...
        {
            _face = new ImageBox { Transform = new Transform2(new Rectangle(position.X + 10, position.Y + 12, 70, 70)) };
            _label = new Label
            {
                Font = "Fonts/12",
            ...
            _visuals.Add(new ImageBox { Image = "UI/weapon-panel.png", Alpha = 180, Transform = new Transform2(new Rectangle(position.X, position.Y, 220, 114)) });
            _visuals.Add(_face);
            _visuals.Add(_label);
            _visuals.Add(_hp);
        }
